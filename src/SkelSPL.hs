...
transTopDef x = case x of
  FnDef _ type_ vident arguments block -> failure x
  ClDef _ cident classarguments -> failure x
transArgument :: Show a => Argument a -> Result
transArgument x = case x of
  Arg _ type_ vident -> failure x
transClassArgument :: Show a => ClassArgument a -> Result
transClassArgument x = case x of
  Field _ type_ vidents -> failure x
...
transItem x = case x of
  NoInit _ vident -> failure x
  Init _ vident expr -> failure x
transType :: Show a => Type a -> Result
transType x = case x of
  Int _ -> failure x
  Bool _ -> failure x
  Void _ -> failure x
  Class _ cident -> failure x
...
transExpr x = case x of
  ...
  ETrue _ -> failure x
  EFalse _ -> failure x
  EVar _ vident -> failure x
  EField _ expr vident -> failure x
  ...
  EObjNew _ cident -> failure x
  EArrNew _ type_ expr -> failure x
  ELambda _ arguments stmt -> failure x
